...
public class InitialScene: SKScene {
    public override func didMove (to view: SKView) {
        self.addChild(createObject(folder: "", name: "temp", position: startButtonPos))
//        createButton(imageNamed: "temp", position: startButtonPos)
    }
    
    func touchButton (atPoint pos: CGPoint) {
        // highlight
        self.addChild(createObject(folder: "", name: "temp_h", position: startButtonPos))
//        self.createButton(imageNamed: "temp_h", position: startButtonPos)
