...
class WinScene: SKScene {
    public override func didMove (to view: SKView) {
        self.addChild(createLabel(text: "Congratulations!", position: CGPoint(x: 0, y: 96), size: 24))
        self.addChild(createLabel(text: "You've cleaned the park!", position: CGPoint(x: 0, y: 160)))
